...
void lcd_send_byte(uint8_t val, int mode) {
    ...
    uint8_t high = mode | (val & 0xF0) | LCD_BACKLIGHT;   // the actuall part of the byte gets sent in the first nibble; the other nibble is to inable the light to blink
...
int main() {
    ...
    while (1) {
        ...
        //         lcd_send_string(message[m + line]);
        //     }
        //     sleep_ms(2000);
        //     lcd_clear();
        // }
